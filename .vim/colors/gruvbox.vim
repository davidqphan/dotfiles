...
let s:gb.bright_green   = ['#ffffff', 255]     " 184-187-38
...
let s:gb.neutral_green  = ['#ffffff', 255]     " 152-151-26
...
let s:gb.faded_green    = ['#ffffff', 255]     " 121-116-14
...
if g:gruvbox_improved_strings == 0
  ...
  "call s:HL('Special', s:bg1, s:blue, s:italic) 
...
hi! link pythonBultinFunc GruvBoxBlue
